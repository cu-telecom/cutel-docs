...
This is a somewhat vague config dump for the VG224s, which might be useful for clues. In future we'll add more documentation.
...
!
!
snmp-server community TopSecret RO
!
control-plane
!
!
